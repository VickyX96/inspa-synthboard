...
export async function exportEmbedZip() {
  ...
  folder.file('inspa-synthboard-player.css', ':host{display:block;min-height:240px;background:#09090a}canvas{width:100%;height:100%;display:block}button{font:12px system-ui;color:#090909;background:#fff;border:0;padding:8px 12px}')
